# coding: utf-8
# Wizard hook
from wiz_guerilla import guerilla_utils
from wiz_guerilla import custom_import
...
def after_scene_openning(stage_name, string_asset):
	...
	children = guerilla_utils.get_Document_children('SceneGraphNode', False)
	if stage_name == 'custom' and 'custom_GRP' not in children:
		print("Setting-up for custom")
		with modifier as mod:
			mod.createnode("custom_GRP")
	if stage_name == 'shading' and 'shading_GRP' not in children:
		print("Setting-up for shading")
		with modifier as mod:
			mod.createnode('shading_GRP')
	pass		
